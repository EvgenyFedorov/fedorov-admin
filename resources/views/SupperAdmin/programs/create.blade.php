            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="margin: 0 0 20px 0;">
                        ...
                        <span>Добавление приложения</span>
                    </div>
                </div>
            </div>
            <div class="card">
                        ...
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            ...
                            <div class="card-body" style="padding: 20px 0 20px 0; margin: 0;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="program_name" type="text" class="form-control @error('program_name') is-invalid @enderror" name="program_name" value="" required autocomplete="program_name" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="program_bot_name" type="text" class="form-control @error('program_bot_name') is-invalid @enderror" name="program_bot_name" value="" required autocomplete="program_bot_name">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary" id="program_add_execute">
